  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-[#e2e2e2] to-[#c9d6ff]">
      <div className={`container relative w-[850px] h-[550px] bg-white m-5 rounded-[30px] shadow-lg overflow-hidden ${isActive ? 'active' : ''}`}>
        ...
        {/* Login Form */}
        <div 
          className="form-box login absolute top-0 w-1/2 h-full bg-white flex items-center text-gray-800 text-center p-10 z-10"
          style={{
            left: isActive ? '-100%' : '0',
        ...
        {/* Register Form */}
        <div 
          className="form-box register absolute top-0 w-1/2 h-full bg-white flex items-center text-gray-800 text-center p-10 z-10"
          style={{
